---
sidebarTitle: "游戏开发血泪史：那些没人告诉你的坑"
title: "游戏开发血泪史：那些没人告诉你的坑"
---
> **摘要**：本文聚焦「游戏开发血泪史：那些没人告诉你的坑」，梳理核心概念、关键方法与落地实践。
...
*   **⏱️ CCD (连续碰撞检测):** 如果必须用刚体，在 Rigidbody 设置里把 `Collision Detection` 改为 `Continuous`。但这比较耗性能。
