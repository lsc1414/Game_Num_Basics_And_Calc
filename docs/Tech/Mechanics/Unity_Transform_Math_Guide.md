---
sidebarTitle: "📐 Unity Transform 数学变换与最佳实践"
---

# 📐 Unity Transform 数学变换与最佳实践
...
#### 案例 I: 3D 物体飞向 UI (World Object to UI Fly Effect) - 进阶版
...
- **应用场景:**
  ...
  1.  **视野检测 (FOV):** 判断敌人是否在玩家前方夹角内。
      ...
      // Dot > 0 在前方 180度范围内
      \text{if} (Vector3.Dot(transform.forward, toEnemy) > 0.5f) { /* 在视野内 */ }
      ```
